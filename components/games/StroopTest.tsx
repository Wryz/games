...
import { getStroopTestScores } from '@/lib/scores'
...
export default function StroopTest() {
  ...
  const formatScore = (score: StroopTestScore) => {
    return `${score.correct_answers}/${score.total_questions} (${score.average_time}ms avg)`
  }
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center min-h-[400px] sm:min-h-[600px] bg-gray-50 dark:bg-gray-800 rounded-lg p-4 sm:p-8">
        <StroopTestIcon size={80} className="mb-4 text-blue-600 dark:text-blue-400 sm:w-24 sm:h-24" />
