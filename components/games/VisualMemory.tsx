...
import { getVisualMemoryScores } from '@/lib/scores'
...
export default function VisualMemory() {
  ...
  const formatScore = (score: VisualMemoryScore) => {
    return `Level ${score.level_reached} (${score.patterns_remembered}/${score.total_patterns})`
  }
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center min-h-[400px] sm:min-h-[600px] bg-gray-50 dark:bg-gray-800 rounded-lg p-4 sm:p-8">
        <VisualMemoryIcon size={80} className="mb-4 text-blue-600 dark:text-blue-400 sm:w-24 sm:h-24" />
